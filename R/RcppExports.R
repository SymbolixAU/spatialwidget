...
rcpp_make_colours <- function(lst_params, params, data, lst_defaults, col_index, palette_type, alpha, colour_name, include_legend, legend_digits = 2L) {
    .Call(`_spatialwidget_rcpp_make_colours`, lst_params, params, data, lst_defaults, col_index, palette_type, alpha, colour_name, include_legend, legend_digits)
}

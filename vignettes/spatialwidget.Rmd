...
The other is used for down-casting MULTI geometry objects into their equivalent non-MULTI objects. (For example, if you have a MULTIPOINT object, but the widget can only handle POINTs, you will have to down-cast the MULTIPOINT to POINTS)

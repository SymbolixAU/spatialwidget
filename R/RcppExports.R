...
rcpp_widget_point_df_columnar <- function(data, params, jsonify_legend, digits) {
    .Call(`_spatialwidget_rcpp_widget_point_df_columnar`, data, params, jsonify_legend, digits)
}

...
rcpp_make_colours <- function(lst_params, params, data, lst_defaults, col_index, palette_type, alpha, colour_name, include_legend, repeats, total_colours, legend_digits = 2L, colour_format = "hex") {
    .Call(`_spatialwidget_rcpp_make_colours`, lst_params, params, data, lst_defaults, col_index, palette_type, alpha, colour_name, include_legend, repeats, total_colours, legend_digits, colour_format)
}

rcpp_resolve_colour <- function(lst_params, params, data, lst_defaults, colour_name, opacity_name, lst_legend, include_legend, repeats, total_colours, colour_format = "hex") {
